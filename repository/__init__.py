...
BIGONE_HOME ="/Users/aanantham/Documents/skeleton-htmengine-app"
g_log = logging.getLogger("thebigone.repository")

config = Config("application.conf", os.path.join(BIGONE_HOME, "conf"), mode=Config.MODE_LOGICAL)
...
def reset(offline=False):
  """
  Reset the bigone database; upon successful completion, the necessary schema are
